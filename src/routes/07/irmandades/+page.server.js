...
export const actions = {
    guerreiros: async ({ request }) => { 
        ...
        if (forca < 7) return fail(400, { error: 'Precisa estudar mais!' });
    ...
    artesaos: async ({ request }) => { 
        ...
        if (destreza < 6) return fail(400, { error: 'Precisa de habilidades manuasi!' });

        if (ferramentas!= 'on') return fail(400, { error: 'Sem conhecimentos de ferramentas!' });
